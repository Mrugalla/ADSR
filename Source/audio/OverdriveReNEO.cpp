...
namespace audio
{
	...
	void OverdriveReNeo::operator()(float* const* samples, int numChannels, int numSamples,
	...
	void OverdriveReNeo::processBlockStereo(float* const* samples, int numChannels, int numSamples,
